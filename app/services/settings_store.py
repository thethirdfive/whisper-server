...
EDITABLE: list[Field] = [
    ...
    Field("gdrive_oauth_client_id", "Google OAuth 客户端 ID", "Google Drive", "str",
          help="GCP Web 客户端 ID，授权 JS 来源填你的访问域名"),
    Field("gdrive_api_key", "Google API Key", "Google Drive", "str",
          help="GCP API Key（启用 Picker API + Drive API）"),
